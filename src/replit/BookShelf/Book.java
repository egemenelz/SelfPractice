...
public class Book {
    ...
    public static String capitalize(String word) {
        if (word.isEmpty()) {
            ...
            word = word.substring(0, 1).toUpperCase() + word.substring(1, word.indexOf(" ")).toLowerCase() + word.substring(word.indexOf(" ") + 1, word.indexOf(" ") + 2).toUpperCase() + word.substring(word.indexOf(" ") + 2).toLowerCase();
        } else {
     ...
     * @param author : String
     *               Conditions:
     *               => if parameter author value is empty, 1) "Unknown" is assigned to instance variable author
